<template>
    <div>
        ...
        <div class="modal" id="forumModal">
            <div class="modal-box">
                ...
                <form @submit.prevent="addForum">
                    ...
                    <div class="flex flex-col">
                        <label for="title">Konten Forum</label>
        ...
        <!-- end forum modal -->
        <h1 class="text-center text-2xl my-3 font-semibold">ChevaNime Forum</h1>
        ...
        <div v-if="!isLoading && !isError" class="px-24">
            <div class="my-2 space-x-2">
                ...
                <select class="select w-xs select-bordered" v-model="forumType">
